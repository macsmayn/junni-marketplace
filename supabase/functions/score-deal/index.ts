...
- distributions: any cash paid out to owners, shareholders, partners, or unitholders during the fiscal year, however described in the source documents — dividends declared or paid, partner distributions, shareholder draws, owner withdrawals, or distributions to unitholders. Read from the financing activities section of the cash flow statement or from the notes. Return as a POSITIVE number. Null only when the documents show no such payment occurred during the year; do NOT return null based on the company's legal structure.
